...
## Merchant Setup
<div style="color: red; border: 1px red solid; margin: 3px 16px;">This version of PurseStrings contains a *significant* update to the Merchant Inventory system and the syntax for the [`--give`](#--give) and [`--buy`](#--buy) commands. If you have used a previous version of this script, please pay close attention to the following documentation for changes you will need to make to any characters and/or macros you may be using.</div>
